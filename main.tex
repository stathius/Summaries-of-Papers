...
They draw a connection between probabilities and the Hamiltonian H of a system. In physics the H denotes the energy of a system and indicates how many configurations it can take. For example the probability can be written as:
\begin{equation}
